 ...
 * {@link #setTextAppearance(android.content.Context, int)
...
public class Switch extends CompoundButton {
    ...
    public Switch(Context context, AttributeSet attrs, int defStyle) {
        ...
        mThumbDrawable = a.getDrawable(R.styleable.Switch_thumbDrawable);
        mTrackDrawable = a.getDrawable(R.styleable.Switch_trackDrawable);
        ...
        int id = a.getResourceId(R.styleable.Switch_switchTextAppearance, 0);
        if (id != 0){
            setSwitchTextAppearance(context,id);
        }
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (isChecked()) {
            ...
            if (TextUtils.isEmpty(text)) {
                text = getContext().getString(R.string.switcher_open);
            }
            event.getText().add(text);
        } else {
            CharSequence text = mOffLayout.getText();
            if (TextUtils.isEmpty(text)) {
                text = getContext().getString(R.string.switcher_close);
            }
            event.getText().add(text);
        }
    }
