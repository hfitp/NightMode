...
public class Constant {
    ...
    /** Broadcast message */
    public static final String BDC_PREFERENCE_CHANGED = "bdc_preference_changed";
    public static final String BDC_PREFERENCE_CHANGED_FOR_ACT = "bdc_switch_mode";
    public static final String BDC_SERVICE_CLOSED = "night_service_closed";
    ...
    public static final String KEY_SERVICES_STARTUP = "service_autostart_on_startup";
    public static final String KEY_SERVICES_SHOW_NOTIFICATION = "service_show_notification";
    ...
    public static final String KEY_NIGHTLY_FOR_ALL_APP = "nighlty_apply_for_all";
    ...
    public static final int TAG_ID_FLOAT_WIDGET = 0XFFF3;
    ...
    public static final int TAG_ID_ALERT = 0XFFFFFD;
