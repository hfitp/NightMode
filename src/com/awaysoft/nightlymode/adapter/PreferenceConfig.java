 ...
 * @since 2014
 */
public enum PreferenceConfig {
    INSTANCE;

    public final int HEADER = PreferenceItemHolder.ITEM_TYPE_HEADER;
    public final int NORMAL = PreferenceItemHolder.ITEM_TYPE_NORMAL;
    public final int SWITCHER = PreferenceItemHolder.ITEM_TYPE_SWITCHER;
    public final int CHECKBOX = PreferenceItemHolder.ITEM_TYPE_CHECKBOX;

    private final ArrayList<PreferenceItemHolder> sPreferenceItems;
    ...
    public void build(Context context) {
        sPreferenceItems.clear();
        {
            ...
            sPreferenceItems.add(new PreferenceItemHolder(SWITCHER, R.string.preference_auto_start, R.string.preference_autostart_tips, Constant.TAG_ID_AUTO_START));
            ...
            sPreferenceItems.add(new PreferenceItemHolder(SWITCHER, R.string.preference_floatwidget, R.string.preference_floatwidget_tips, Constant.TAG_ID_FLOAT_WIDGET));
            sPreferenceItems.add(new PreferenceItemHolder(SWITCHER, R.string.preference_alert_night, R.string.preference_alert_night_tips, Constant.TAG_ID_ALERT));
    ...
    public PreferenceItemHolder get(int position) {
    ...
    public void onPreferenceChanged(Context context, int tag) {
        Intent intent = new Intent(Constant.BDC_PREFERENCE_CHANGED);
